...
class AppColors {
  // Primary Colors
  static const Color primaryColor = Color(0xff2F9519); // Green shade
  static const Color primaryLightColor = Color(0xFFC8E6C9); // Light green shade
  static const Color primaryDarkColor = Color(0xFF388E3C); // Dark green shade
